...
public class EmployeeRestController {
	...
	public TranscationEntryCounts getTranscationEntryCounts() {
		return (new TranscationEntryCountsQuery()).execute();
	}

	@RequestMapping(value = "/apiv0/transactions", method = RequestMethod.PUT)
	...
	@RequestMapping(value = "/apiv0/transactionEntries", method = RequestMethod.PUT)
	public Transaction putTransaction(@RequestBody Transaction transaction) {
