...
public class TransactionEntity extends BaseEntity<TransactionEntity> {
	...
	protected void fillFromRecord(ResultSet rs) throws SQLException {
		this.lookupCode = rs.getString(TransactionFieldNames.CASHIER_ID);
		this.count = rs.getInt(TransactionFieldNames.REFERENCE_ID);
		this.count = rs.getInt(TransactionFieldNames.TOTAL_AMOUNT);
		this.count = rs.getInt(TransactionFieldNames.TYPE);
